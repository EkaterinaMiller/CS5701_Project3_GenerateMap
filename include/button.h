...
class Button: public sf::Drawable
{
    ...
    Button(const std::string& s, sf::Vector2f position, sf::Vector2f size, sf::Color color);
    ~Button(){};
    ...
    sf::Vector2f getDimensions(){return mButton.getGlobalBounds().size;}
    state getState(){return mBtnState;};
